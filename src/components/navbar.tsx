  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Mobile hamburger */}
        <button
          className="md:hidden flex items-center justify-center min-w-[44px] min-h-[44px] rounded-lg text-text-secondary-dark hover:text-white hover:bg-surface-dark-hover transition-colors"
